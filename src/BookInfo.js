    ...
    <div className="flex flex-col gap-36 text-center">
      ...
      { book && (
        <article className="flex flex-col gap-10 text-center">
          ...
          <h2 className="text-titleColor mx-auto text-2xl max-w-sm text-3xl font-medium
          sm:max-w-2xl md:max-w-2xl lg:text-5xl lg:max-w-4xl">{ book.title }</h2>
          ...
          <p className="text-paragraphColor text-ellipsis tracking-wide leading-relaxed text-sm max-w-sm px-10 
